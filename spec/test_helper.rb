...
def load_best_test_data
  ...
  @half_dozen1 = BulkDiscount.create!(name: "Half Dozen", discount: 0.10, threshold: 6, merchant: @merchant1)
  @baker1 = BulkDiscount.create!(name: "Baker", discount: 0.20, threshold: 13, merchant: @merchant1)
  @gross1 = BulkDiscount.create!(name: "Gross", discount: 0.30, threshold: 144, merchant: @merchant1)
  @nope1 = BulkDiscount.create!(name: "Nope", discount: 0.99, threshold: 999, merchant: @merchant1)
  @dozen2 = BulkDiscount.create!(name: "Dozen", discount: 0.10, threshold: 12, merchant: @merchant2)
  @half_dozen1 = BulkDiscount.create!(name: "Half Dozen", discount: 0.10, threshold: 6, merchant: @merchant2)
  @baker2 = BulkDiscount.create!(name: "Baker", discount: 0.20, threshold: 13, merchant: @merchant2)
  @gross2 = BulkDiscount.create!(name: "Gross", discount: 0.30, threshold: 144, merchant: @merchant2)
  @nope2 = BulkDiscount.create!(name: "Nope", discount: 0.99, threshold: 999, merchant: @merchant2)
  @dozen3 = BulkDiscount.create!(name: "Dozen", discount: 0.10, threshold: 12, merchant: @merchant11)
  @baker3 = BulkDiscount.create!(name: "Baker", discount: 0.20, threshold: 13, merchant: @merchant11)
  @gross3 = BulkDiscount.create!(name: "Gross", discount: 0.30, threshold: 144, merchant: @merchant11)
  @nope3 = BulkDiscount.create!(name: "Nope", discount: 0.99, threshold: 999, merchant: @merchant11)
end 